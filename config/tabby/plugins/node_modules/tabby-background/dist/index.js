(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("@angular/common"), require("@angular/core"), require("@angular/forms"), require("@ng-bootstrap/ng-bootstrap"), require("tabby-core"), require("tabby-settings"), require("@angular/cdk/drag-drop"), require("ngx-toastr"), require("tabby-electron"));
	else if(typeof define === 'function' && define.amd)
		define(["@angular/common", "@angular/core", "@angular/forms", "@ng-bootstrap/ng-bootstrap", "tabby-core", "tabby-settings", "@angular/cdk/drag-drop", "ngx-toastr", "tabby-electron"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("@angular/common"), require("@angular/core"), require("@angular/forms"), require("@ng-bootstrap/ng-bootstrap"), require("tabby-core"), require("tabby-settings"), require("@angular/cdk/drag-drop"), require("ngx-toastr"), require("tabby-electron")) : factory(root["@angular/common"], root["@angular/core"], root["@angular/forms"], root["@ng-bootstrap/ng-bootstrap"], root["tabby-core"], root["tabby-settings"], root["@angular/cdk/drag-drop"], root["ngx-toastr"], root["tabby-electron"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(global, (__WEBPACK_EXTERNAL_MODULE__angular_common__, __WEBPACK_EXTERNAL_MODULE__angular_core__, __WEBPACK_EXTERNAL_MODULE__angular_forms__, __WEBPACK_EXTERNAL_MODULE__ng_bootstrap_ng_bootstrap__, __WEBPACK_EXTERNAL_MODULE_tabby_core__, __WEBPACK_EXTERNAL_MODULE_tabby_settings__, __WEBPACK_EXTERNAL_MODULE__angular_cdk_drag_drop__, __WEBPACK_EXTERNAL_MODULE_ngx_toastr__, __WEBPACK_EXTERNAL_MODULE_tabby_electron__) => {
...
let BackgroundService = class BackgroundService {
    ...
    applyBackgroundPreview() {
        this.backgroundStyleElement.innerHTML = this.buildBackgroundCss(this.pluginConfig.backgrounds[this.previewIndex]);
    }
    addBackground() {
        const newBackground = Object.assign({}, _config_provider__WEBPACK_IMPORTED_MODULE_2__.DefaultBackground);
        newBackground.id = uuid__WEBPACK_IMPORTED_MODULE_4__["default"]();
    ...
    enterSlideShow() {
        const handler = () => {
            ...
            this.backgroundStyleElement.innerHTML = this.backgroundStyleElement.innerHTML.replace("/*background-placeholder*/", "opacity: 0;");
...
let BackgroundSettingsTabComponent = class BackgroundSettingsTabComponent {
    ...
    async pickFile(background) {
        const paths = (await this.electron.dialog.showOpenDialog(this.hostWindow.getWindow(), {
            filters: [
